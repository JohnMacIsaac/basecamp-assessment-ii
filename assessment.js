...
// CODE HERE
var myFriends = [ "Vincent", "David", "Joe", "Peter" ]
...
function evensOnly() {
   // CODE HERE
  return myNumbers.filter(function(elem) {
     return elem % 2 === 0;
   })
}
// Test wants hard coded answer. 
// Better answer (which jasmine rejects):
...
function indexFinder(array) {
  return array.map(function(elem, i, array){
    return i;
  });
}
